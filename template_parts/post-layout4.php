                        ...
                        <div class="post_image">
                            ...
                            <div class="imgwrap">
                                ...
                                <a href="<?php the_permalink();?>">
                                    <img src="<?php echo optimizer_gallery_thumb();?>" alt="<?php the_title_attribute(); ?>" class="thn_thumbnail"/>
                                </a>
                            </div>
                            ...
                            <div class="imgwrap">
                                <a href="<?php the_permalink();?>">
                                    <img alt="<?php the_title(); ?>" src="<?php echo optimizer_first_image(); ?>" />
                                </a>
                            </div>
