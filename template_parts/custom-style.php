...
a:visited, .single_post_content .tabs li a{ color:<?php echo $optimizer['primtxt_color_id']; ?>;}
.single_metainfo a[href*=http]:hover{ color:<?php echo $optimizer['sec_color_id']; ?>;}
.single_metainfo a{color:<?php echo $optimizer['sidebartxt_color_id'] ?>;}
...
/*-----------------------------COLORS------------------------------------*/
	...
	/*MENU Text Color*/
		...
		.search-toggle-svg{fill:<?php echo $optimizer['menutxt_color_id'] ?>;}
		body.has_trans_header.home .search-toggle-svg{fill:<?php echo $optimizer['trans_header_color'] ?>;}
		.search_hover .search-toggle-svg rect, .search_hover .search-toggle-svg path, .search_hover .search-toggle-svg polygon {fill:<?php echo $optimizer['menutxt_color_hover'] ?>; transition: all 0.2s ease-out;}
		body.has_trans_header.home .search_hover .search-toggle-svg rect, body.has_trans_header.home .search_hover .search-toggle-svg path, body.has_trans_header.home .search_hover .search-toggle-svg polygon {fill:<?php echo $optimizer['menutxt_color_hover'] ?>; transition: all 0.2s ease-out;}
		.search_hover .search_underline {background-color: <?php echo $optimizer['menutxt_color_hover'] ?>; width: 100%; margin-top: 2px;}
		.click_search .search underline, .click_search .search-toggle-svg{fill:<?php echo $optimizer['menutxt_color_active'] ?>;}
...
<?php if($optimizer['sec_color_id']){ ?>
	...
	/*Text Color on BASE COLOR Element*/
		...
		.blog_mo a, .ellipsis a{color:<?php echo $optimizer['primtxt_color_id']; ?>;}
